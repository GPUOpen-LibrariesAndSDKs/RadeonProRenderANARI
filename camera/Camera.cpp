...
/*static FactoryMap<Camera> g_cameras = {

    {"perspective", [](rpr_camera &camera) -> Camera * { return new Perspective(camera); }}
...
Camera *Camera::createInstance(rpr_context &context, const char *type)
{
  ...
  return new Perspective(camera);  // TODO more camera types
