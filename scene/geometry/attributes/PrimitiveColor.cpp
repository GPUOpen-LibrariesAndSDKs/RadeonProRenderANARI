...
PrimitiveColor::PrimitiveColor(rpr_context context, rpr_material_system matsys, rpr_uint num_primitives, const float *colors)
{
  ...
  CHECK(rprContextCreateBuffer(context, &bufferDesc, colors, &m_buffer))
