...
void QuadLight::commit(){
  ...
  rpr_uint mode = strcmp(side.c_str(), "both") == 0 ? RPR_UBER_MATERIAL_EMISSION_MODE_DOUBLESIDED : RPR_UBER_MATERIAL_EMISSION_MODE_SINGLESIDED;
  ...
  CHECK(rprMaterialNodeSetInputFByKey(m_material, RPR_MATERIAL_INPUT_UBER_EMISSION_COLOR, m_color.r * resultPower, m_color.g * resultPower, m_color.b * resultPower, 1.f))
  CHECK(rprMaterialNodeSetInputFByKey(m_material, RPR_MATERIAL_INPUT_UBER_EMISSION_WEIGHT, 1.f, 1.f, 1.f, 1.f))
