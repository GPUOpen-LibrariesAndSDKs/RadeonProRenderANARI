...
void ScivisVolume::commit()
{
  ...
  if(!opacity) throw std::runtime_error("'opacity' is a required parameter");
  ...
  CHECK(rprMaterialNodeSetInputGridDataByKey(
      m_color_grid_material, RPR_MATERIAL_INPUT_DATA, m_color_grid))
  ...
  CHECK(rprMaterialNodeSetInputGridDataByKey(
      m_density_grid_material, RPR_MATERIAL_INPUT_DATA, m_density_grid))
  ...
  CHECK(rprMaterialNodeSetInputNByKey(m_color_material, RPR_MATERIAL_INPUT_UV,
                                      m_color_grid_material))
  ...
  CHECK(rprMaterialNodeSetInputNByKey(m_volume_material, RPR_MATERIAL_INPUT_DENSITYGRID, m_density_grid_material))
